...
namespace publicacion
{
         ...
         public string Nombre
    {
        ...
        }
      {
        ...
        pública  anulación  vacío  de impresión ()
        {
    ...
    clase  Publicacion_fotos : publicacion
    {
        público  Publicacion_fotos ( cadena de  nombre , cadena  mensaje , cadena de fecha , cadena  correo  )
        {
